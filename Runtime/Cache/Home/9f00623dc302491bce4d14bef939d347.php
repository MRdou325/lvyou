                    ...
                    <li>
                        <div class="pic">
                            <a href="<?php echo U('Goods/info',array('id'=> $goods["goods_id"]));?>" target="_blank" title="<?php echo ($goods["title"]); ?>">
                                <img src="<?php echo (get_image_url($goods['pic_url'])); ?>" border="0" alt="<?php echo ($goods["title"]); ?>" width="75" height="50" original="<?php echo (get_image_url($goods['pic_url'])); ?>" style="display: block;">
                            </a>
                        </div>
                        <div class="type">
