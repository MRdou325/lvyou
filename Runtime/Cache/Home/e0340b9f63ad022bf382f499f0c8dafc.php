...
<link rel="stylesheet" href="/ke361/Public/Home/css/nivo-slider.css" type="text/css" media="screen" />
	<div id="slider" class="nivoSlider">
		<?php if(is_array($banner)): $k = 0; $__LIST__ = $banner;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$data): $mod = ($k % 2 );++$k;?><img src="<?php echo ($data["image"]); ?>" alt="<?php echo ($data["title"]); ?>" title="<?php echo ($data["title"]); ?>" /><?php endforeach; endif; else: echo "" ;endif; ?>
	</div>
