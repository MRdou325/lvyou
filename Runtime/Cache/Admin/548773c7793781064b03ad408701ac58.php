                                    ...
                                    <form action="<?php echo U('Index/sortList',array('op'=>'order'));?>" method="post">
                                        <div class="table-responsive">
                                            <table class="table table-striped table-bordered table-hover">
                                                ...
                                                <tbody>
                                                <?php if(!empty($TagModel)): if(is_array($TagModel)): $i = 0; $__LIST__ = $TagModel;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$data): $mod = ($i % 2 );++$i;?><tr class="pointer even" title="">
                                                        ...
                                                        <td class="center"><a href="<?php echo U('Tag/status',array('id'=>$data['id']));?>"><?php echo ($data['status']==1?'<font color="green">开启</font>':'<font color="red">关闭</font>'); ?></a></td>

                                                        <td>
                                                            <a href="<?php echo U('Tag/add',array('id'=>$data['id']));?>">编辑</a>
                                                            |
                                                            <a onclick="return confirm('确定删除')" href="<?php echo U('Tag/del',array('id'=>$data['id']));?>" title="删除">删除</a>
                                                        </td>
