		...
		<table>
			...
			<tbody>
				<?php if(!empty($list)): if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$channel): $mod = ($i % 2 );++$i;?><tr>
						...
						<td class="center"><?php echo ($channel['head']==1?'<font color="green">开启</font>':'<font color="red">关闭</font>'); ?></td>
						<td class="center"><?php echo ($channel['side']==1?'<font color="green">开启</font>':'<font color="red">关闭</font>'); ?></td>
						<td class="center"><?php echo ($channel['foot']==1?'<font color="green">开启</font>':'<font color="red">关闭</font>'); ?></td>
