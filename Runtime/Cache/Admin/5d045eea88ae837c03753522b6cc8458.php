    ...
    <div class="container">
        <script type="text/javascript" src="/lvyou/Public/static/uploadify/jquery.uploadify.min.js"></script>
                <div class="row">
                    <div class="col-xs-12">
                        <!-- PAGE CONTENT BEGINS -->                        
                            <form class="form-horizontal" role="form" action="<?php echo U('Tag/add');?>" method="post">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-9">
                                        ...
                                        <input type="hidden" name="pic_url" id="pic_url" value="<?php echo ((isset($tag['pic_url']) && ($tag['pic_url'] !== ""))?($tag['pic_url']):''); ?>"/>
                                        <div class="upload-img-box">
                                            <?php if(!empty($tag['pic_url'])): ?><div class="upload-pre-item"><img src="/lvyou<?php echo ($tag["pic_url"]); ?>"/></div><?php endif; ?>
                                        </div>
                                    </div>
                                ...
                                <div class="form-group">
                                        ...
                                        <div class="col-sm-9">
                                                <input type="text" name="order" value="<?php echo intval($tag['sort']);?>" class="form-control" />
                                        </div>
                                </div>
                                ...
                                <div class="form-group">
										...
										<div class="col-sm-9">
                                            <select name="state">
                                                <option value="1" <?php if($tag["status"]==1){ ?>selected<?php } ?>>开启</option>
                                                <option value="0" <?php if($tag["status"]==0){ ?>selected<?php } ?>>关闭</option>
                                            </select>
                                        </div>
                                </div>
