...
<body>
    ...
    <script type="text/javascript" src="/ke361/Public/Admin/js/js.js"></script>
    ...
    <div class="cf">
        ...
        <!-- <div class="search-form fr cf">
            <div class="sleft">
                ...
                <a class="sch-btn" href="javascript:;" id="search" url="/ke361/index.php?s=/Admin/Page/index.html"><i class="btn-search"></i></a>
            </div>
        </div> -->
    </div>
                ...
                <form action="<?php echo U('Index/sortList',array('op'=>'order'));?>" method="post">
                    <div class="table-responsive">
                        <table class="table table-striped table-bordered table-hover">
                            ...
                            <tbody>
                                <?php if(!empty($pageList)): if(is_array($pageList)): $i = 0; $__LIST__ = $pageList;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$data): $mod = ($i % 2 );++$i;?><tr class="pointer even" title="">
                                            <td><input type="text" name="order_<?php echo ($data['sort_id']); ?>" value="<?php echo ($data['sort']); ?>" style="width:30px;padding:0 5px;margin:0"/></td>
                                            <td><?php echo ($data['id']); ?>-<?php echo ($data['name']); ?></td>
                                            <td class="center"><?php echo ($data['ishome']==1?'<font color="green">显示</font>':'<font color="red">关闭</font>'); ?></td>
                                            <td class="center"><a href="<?php echo U('Page/status',array('id'=>$data['id']));?>"><?php echo ($data['status']==1?'<font color="green">开启</font>':'<font color="red">关闭</font>'); ?></a></td>
                                            <td><a href="<?php echo U('Page/add',array('id'=>$data['id']));?>">编辑</a>
                                                            |
                                                <a onclick="return confirm('该分类下的商品将全部删除，确定删除')" href="<?php echo U('Page/del',array('id'=>$data['id']));?>" title="删除">删除</a>
                                            </td>
