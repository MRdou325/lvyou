...
<body>
	...
	<form action="<?php echo U();?>" method="post" class="form-horizontal">
        ...
        <div class="form-item">
            ...
            <div class="controls">
                <select name="target">
                     <option value="0" <?php if($info["target"]==0){ ?>selected<?php } ?>>否</option>
					 <option value="1" <?php if($info["target"]==1){ ?>selected<?php } ?>>是</option>
                </select>
            </div>
        </div>
        <div class="form-item">
            <label class="item-label">顶部导航<span class="check-tips">（是否显示在顶部导航）</span></label>
            <div class="controls">
                <select name="head">
                     <option value="0" <?php if($info["head"]==0){ ?>selected<?php } ?>>否</option>
					 <option value="1" <?php if($info["head"]==1){ ?>selected<?php } ?>>是</option>
                </select>
            </div>
        </div>
        <div class="form-item">
            <label class="item-label">边栏导航<span class="check-tips">（是否显示在边栏导航）</span></label>
            <div class="controls">
                <select name="side">
                     <option value="0" <?php if($info["side"]==0){ ?>selected<?php } ?>>否</option>
					 <option value="1" <?php if($info["side"]==1){ ?>selected<?php } ?>>是</option>
                </select>
            </div>
        </div>
        <div class="form-item">
            <label class="item-label">底部导航<span class="check-tips">（是否显示在底部导航）</span></label>
            <div class="controls">
                <select name="foot">
                     <option value="0" <?php if($info["foot"]==0){ ?>selected<?php } ?>>否</option>
					 <option value="1" <?php if($info["foot"]==0){ ?>selected<?php } ?>>是</option>
                </select>
            </div>
        </div>
		<div class="form-item">
