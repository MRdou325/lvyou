    ...
    <div class="cf">
        ...
        <!-- <div class="search-form fr cf">
            <div class="sleft">
                ...
                <a class="sch-btn" href="javascript:;" id="search" url="/lvyou/index.php?s=/Admin/Search/index.html"><i class="btn-search"></i></a>
            </div>
        </div> -->
    </div>
                        ...
                        <table class="table table-striped table-bordered table-hover">
                            ...
                            <tbody>
                                <?php if(!empty($List)): if(is_array($List)): $i = 0; $__LIST__ = $List;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$data): $mod = ($i % 2 );++$i;?><tr class="pointer even" title="">
                                            ...
                                            <td class="center"><a href="<?php echo U('show',array('id'=>$data['id']));?>"><?php echo ($data['isshow']==1?'<font color="green">开启</font>':'<font color="red">关闭</font>'); ?></a></td>
