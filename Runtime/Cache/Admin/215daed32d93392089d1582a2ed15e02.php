    ...
    <div class="cf">
        ...
        <!-- <div class="search-form fr cf">
            <div class="sleft">
                ...
                <a class="sch-btn" href="javascript:;" id="search" url="/lvyou/index.php?s=/Admin/Banner/index.html"><i class="btn-search"></i></a>
            </div>
        </div> -->
    </div>
                ...
                <form action="<?php echo U('Index/sortList',array('op'=>'order'));?>" method="post">
                    <div class="table-responsive">
                        <table class="table table-striped table-bordered table-hover">
                            ...
                            <tbody>
                                <?php if(!empty($bannerList)): if(is_array($bannerList)): $i = 0; $__LIST__ = $bannerList;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$data): $mod = ($i % 2 );++$i;?><tr class="pointer even" title="">
                                            ...
                                            <td class="center"><a href="<?php echo U('Banner/status',array('id'=>$data['id']));?>"><?php echo ($data['status']==1?'<font color="green">开启</font>':'<font color="red">关闭</font>'); ?></a></td>
                                            <td><?php echo ($data['click']); ?></td>
                                            <td><a href="<?php echo U('Banner/add',array('id'=>$data['id']));?>">编辑</a>
                                                            |
                                                <a onclick="return confirm('该分类下的商品将全部删除，确定删除')" href="<?php echo U('Banner/del',array('id'=>$data['id']));?>" title="删除">删除</a>
                                            </td>
