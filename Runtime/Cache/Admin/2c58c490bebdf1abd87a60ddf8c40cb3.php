...
<body>
	...
	<![endif]-->       
                        <form class="form-horizontal" role="form" action="<?php echo U('Goods/extraedit');?>" method="post" enctype="multipart/form-data">
                          <?php echo setParam(array('goods_id'=>$goods_id));?>
                           
                            <div class="form-group">
                                <label class="col-sm-2 control-label no-padding-right" for="form-field-1">名称<span style="color:#f00;">*</span></label>
                                <div class="col-sm-9"><input class="col-sm-12 form-control" type="text" name="name" value="<?php echo ($extra['name']); ?>"></div>
                            </div>

                            <div class="form-group">
                                <label class="col-sm-2 control-label no-padding-right">排序</label>	
                                <div class="col-sm-9"><input class="col-sm-12 form-control" type="text" name="sort" value="<?php echo ($extra['sort']); ?>"></div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    <select class="col-sm-12 form-control" name="status">
                                        <option <?php if($extra["status"]==1){ ?>selected<?php } ?> value="1">开启</option>
                                        <option <?php if($extra["status"]==0){ ?>selected<?php } ?> value="0">关闭</option>
                                    </select>
                                </div>
                            </div>
                ...
                KindEditor.ready(function (K) {
                    ...
                    prettyPrint();
                                ...
                                <div class="col-sm-9">
                                    <textarea class="col-sm-12" name="content" style="height:500px;visibility:hidden;"><?php echo stripslashes($goods['content']);?></textarea>
                                </div>
                            </div>
