                            ...
                            <form class="form-horizontal" role="form" action="<?php echo U('CategoryGoods/add');?>" method="post">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-9">
                                        ...
                                        <div class="upload-img-box">
                                            <?php if(!empty($category['catepic_url'])): ?><div class="upload-pre-item"><img src="/lvyou<?php echo ($category["catepic_url"]); ?>"/></div><?php endif; ?>
                                        </div>
                                    </div>
                                    ...
                                    function uploadPicture(file, data){
                                        ...
                                        if(data.status){
                                            ...
                                            $("#catepic").parent().find('.upload-img-box').html(
                                                '<div class="upload-pre-item"><img src="' + '/lvyou' + src + '"/></div>'
                                            );
                                        } else {
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-9">
                                        ...
                                        <div class="upload-img-box">
                                            <?php if(!empty($category['ad_url'])): ?><div class="upload-pre-item"><img src="/lvyou<?php echo ($category["ad_url"]); ?>"/></div><?php endif; ?>
                                        </div>
                                    </div>
                                    <script type="text/javascript">
                                    //上传图片
                                ...
                                <div class="form-group">
                                        ...
                                        <div class="col-sm-9">
                                            <select name="is_home_banner">
                                                 <option value="0" <?php if($category["is_home_banner"]==0){ ?>selected<?php } ?>>否</option>
                                                 <option value="1" <?php if($category["is_home_banner"]==1){ ?>selected<?php } ?>>是</option>
                                            </select>
                                        </div>
                                </div>
                                ...
                                <div class="form-group">
                                        ...
                                        <div class="col-sm-9">
                                            <select name="is_home_banner_type">
                                                 <option value="0" <?php if($category["is_home_banner_type"]==0){ ?>selected<?php } ?>>文字链接</option>
                                                 <option value="1" <?php if($category["is_home_banner_type"]==1){ ?>selected<?php } ?>>内容图片</option>
                                                 <option value="2" <?php if($category["is_home_banner_type"]==2){ ?>selected<?php } ?>>图片推荐</option>
                                            </select>
                                        </div>
                                </div>
                                ...
                                <div class="form-group">
                                        ...
                                        <div class="col-sm-9">
                                                <input type="text" name="sku" value="<?php echo ($category['sku']); ?>" class="form-control" />
                                        </div>
                                </div>
