...
function check_dirfile(){
	$items = array(
		array('dir',  '可写', 'success', './Uploads/avatar_img'),
		array('dir',  '可写', 'success', './Uploads/goods_img'),
		array('dir',  '可写', 'success', './Uploads/ad_img'),
	    array('dir',  '可写', 'success', './Uploads/article'),
		array('dir',  '可写', 'success', './Runtime'),
		array('dir', '可写', 'success', './Lvyou/User/Conf'),
		array('file', '可写', 'success', './Lvyou/Common/Conf/config.php'),
