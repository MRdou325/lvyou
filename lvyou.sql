...
--
-- Host: 127.0.0.1
-- Generation Time: 2016-06-27 11:58:27
...
(199, 1, 1, 0, 'member', 1, 'admin在2016-04-07 13:21登录了后台', 1, 1460006482),
(200, 10, 1, 0, 'Menu', 171, '操作url：/lvyou/index.php?s=/Admin/Menu/add.html', 1, 1462260935),
(201, 10, 1, 0, 'Menu', 172, '操作url：/lvyou/index.php?s=/Admin/Menu/add.html', 1, 1462260965),
(202, 10, 1, 0, 'Menu', 172, '操作url：/lvyou/index.php?s=/Admin/Menu/edit.html', 1, 1462261012),
(203, 1, 1, 0, 'member', 1, 'admin在2016-05-11 10:22登录了后台', 1, 1462933349),
(204, 6, 1, 0, 'config', 66, '操作url：/lvyou/index.php?s=/Admin/Config/edit.html', 1, 1466664316),
(205, 6, 1, 0, 'config', 67, '操作url：/lvyou/index.php?s=/Admin/Config/edit.html', 1, 1466664384);
...
(1, '/lvyou/Uploads/site_logo/55cafb3fe40e4.jpg', 'www.baidu.com', '这是测试', 1, 0, 0, '文灶 单间出租,1200元一个月,可以煮饭,有空调，有热水器:1000|文灶 60m²绝版好房便宜出租:2000', 1),
(2, '/lvyou/Uploads/site_logo/55cafb3943525.jpg', 'google.com', 'Euro', 1, 0, 0, '', 1),
(3, '/lvyou/Uploads/site_logo/55cafb2d12d10.jpg', '', 'hhhh', 1, 0, 0, 'werwer:1000|weasdfw:2000|gahasd:4000', 1);
...
CREATE TABLE `ly_category_goods` (
  `id` int(10) UNSIGNED NOT NULL COMMENT '宝贝分类id',
...
(18, '新加坡', 1, '', '', 'green', 2, 0, 0, 0, '', 0, 0, 1, 0),
(19, '韩国', 1, '', '', 'green', 2, 0, 0, 1, '', 0, 0, 1, 0),
(20, '泰国', 1, '', '', 'green', 2, 0, 0, 1, '', 0, 0, 1, 0),
(21, '周边攻略', 1, '', '', 'green', 3, 0, 0, 0, '', 0, 0, 0, 0),
(22, '西安', 1, '', '', 'green', 1, 0, 0, 0, 'x', 0, 0, 1, 0);
...
(65, 'HOME_SHOW_RAIDERS_BANNER', 4, '首页轮播攻略', 1, '0:关闭,1:开启', '首页轮播图片位置显示攻略内容', 1466663210, 1466663210, 1, '1', 0),
(66, 'HOME_SHOW_GOODS_BANNER', 4, '首页轮播周边', 1, '0:关闭,1:开启', '首页轮播图片位置显示周边内容', 1466664227, 1466664316, 1, '1', 0),
(67, 'HOME_SHOW_NEWS_BANNER', 4, '首页轮播资讯', 1, '0:关闭,1:开启', '首页轮播图片位置显示资讯内容', 1466664292, 1466664384, 1, '1', 0);
...
CREATE TABLE `ly_favor` (
  `fid` int(10) UNSIGNED NOT NULL COMMENT '收藏id',
...
CREATE TABLE `ly_link` (
  `lid` mediumint(5) UNSIGNED NOT NULL,
  `title` varchar(255) NOT NULL DEFAULT '' COMMENT '标题',
...
(1, 'admin', '', 0, '0000-00-00', '', 40, 5, 0, 1441430549, 0, 1462933349, 1);
...
(171, '行程类型', 131, 0, 'Goods/transtype', 0, '', '攻略', 0),
(172, '增加行程类型', 131, 0, 'Goods/transtypeedit', 0, '', '攻略', 0);
...
INSERT INTO `ly_news` (`id`, `cate_id`, `title`, `pic`, `summary`, `content`, `status`, `source`, `time`, `seo_title`, `seo_keywords`, `seo_description`, `tags`, `add_id`, `add_uname`, `lasttime`) VALUES
(1, 15, '这个是测试的', '', '<p><img src="/ueditor/php/upload/image/20160415/1460685741933746.jpg" title="1460685741933746.jpg" alt="baby-1.jpg"/></p><p>测试简要</p>', '<p>这个是测试内容<br/></p>', 1, '没有', '2016-04-15 02:04:29', 'title', 'keyword', 'description', NULL, 0, 'admin', '2016-04-15 02:04:29'),
(2, 0, '', '', '', '', 1, '', '2016-04-29 03:53:31', '', '', '', NULL, 1, 'admin', '2016-04-29 03:53:31');
...
(50, '/Uploads/goods_img/2016-04-13/570e029d87aca.jpg', '', 'f215e1e57e79bef6a8ca50b6d0f9df91', '3cd47279d37c3ad5376739123b774b55a655c2fb', 1, 1460535964),
(51, '/Uploads/goods_img/2016-04-13/570e029e1ab79.jpg', '', '64d42bc026c3ee72072d7ce6f31a435c', '7c85725b73b5c2693bfc2de3472c7f5249e62811', 1, 1460535965),
(52, '/Uploads/goods_img/2016-04-13/570e029f1af4a.jpg', '', 'b0876b436a5e144e088bbefdc68fb4ed', '01c2e894b1ddcd4550a3e720a6e3f1a5c54f250e', 1, 1460535966),
(53, '/Uploads/goods_img/2016-05-03/5728686e594c0.gif', '', '891854d59f8f899543b312018a04d1cd', 'e028a7bf6f7027650a7aa54d2f4cc5de6c7aabe3', 1, 1462265965);
...
INSERT INTO `ly_raiders` (`id`, `name`, `title`, `cate_id`, `add_id`, `add_uname`, `days`, `traffic`, `price`, `pic_url`, `content`, `status`, `seo_title`, `seo_keywords`, `seo_description`, `ctime`, `hits`, `favor`, `sort`, `tags`, `city_start`, `city_end`, `lasttime`, `trans`) VALUES
(1, '0', '测试', 15, 1, 'admin', 1, '5', '10.00', '/Uploads/goods_img/2016-05-03/5728686e594c0.gif', '<p>测试</p>', 1, '测试', '测试', '测试测试', 1462267229, 0, 0, 0, NULL, '厦门', '永安', 1462339265, '[{"date":"2016-05-01 13:20:07","city":"\\u53a6\\u95e8","addr":"\\u5148\\u540e","type":"1","cost":"0","content":"\\u51fa\\u53d1"},{"date":"2016-05-01 13:20:35","city":"\\u6c38\\u5b89","addr":"\\u6842\\u534e\\u65b0\\u6751","type":"1","cost":"10","content":"\\u5230\\u5bb6\\u5403\\u996d"}]');
...
--
-- 转存表中的数据 `ly_trans_type`
--

INSERT INTO `ly_trans_type` (`id`, `name`, `icon`, `status`) VALUES
(1, '吃饭', '', 1),
(2, '住宿', '', 1),
(3, '购物', '', 0),
(4, '风景区', '', 0);
...
(1, 'admin', '5174bb2558df5314515f46ef639d25c3', '415770123@qq.com', '', 1441430549, 3232286630, 1462933349, 0, 1441430549, 1);
...
--
-- Indexes for table `ly_action`
--
ALTER TABLE `ly_action`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `ly_action_log`
--
ALTER TABLE `ly_action_log`
  ADD PRIMARY KEY (`id`),
...
--
-- Indexes for table `ly_addons`
--
ALTER TABLE `ly_addons`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `ly_article`
--
ALTER TABLE `ly_article`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `ly_attachment`
--
ALTER TABLE `ly_attachment`
  ADD PRIMARY KEY (`id`),
  ADD KEY `idx_record_status` (`record_id`,`status`);

--
-- Indexes for table `ly_attribute`
--
ALTER TABLE `ly_attribute`
  ADD PRIMARY KEY (`id`),
  ADD KEY `model_id` (`model_id`);

--
-- Indexes for table `ly_auth_extend`
--
ALTER TABLE `ly_auth_extend`
  ADD UNIQUE KEY `group_extend_type` (`group_id`,`extend_id`,`type`),
  ADD KEY `uid` (`group_id`),
  ADD KEY `group_id` (`extend_id`);

--
-- Indexes for table `ly_auth_group`
--
ALTER TABLE `ly_auth_group`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `ly_auth_group_access`
--
ALTER TABLE `ly_auth_group_access`
  ADD UNIQUE KEY `uid_group_id` (`uid`,`group_id`),
  ADD KEY `uid` (`uid`),
  ADD KEY `group_id` (`group_id`);

--
-- Indexes for table `ly_auth_rule`
--
ALTER TABLE `ly_auth_rule`
  ADD PRIMARY KEY (`id`),
  ADD KEY `module` (`module`,`status`,`type`);

--
-- Indexes for table `ly_banner`
--
ALTER TABLE `ly_banner`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `ly_category`
--
ALTER TABLE `ly_category`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `uk_name` (`name`),
  ADD KEY `pid` (`pid`);

--
-- Indexes for table `ly_category_goods`
--
ALTER TABLE `ly_category_goods`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `ly_collect_goods`
--
ALTER TABLE `ly_collect_goods`
  ADD PRIMARY KEY (`id`),
  ADD KEY `num_iid` (`num_iid`);

--
-- Indexes for table `ly_config`
--
ALTER TABLE `ly_config`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `uk_name` (`name`),
  ADD KEY `type` (`type`),
  ADD KEY `group` (`group`);
...
--
-- Indexes for table `ly_document`
--
ALTER TABLE `ly_document`
  ADD PRIMARY KEY (`id`),
  ADD KEY `idx_category_status` (`category_id`,`status`),
  ADD KEY `idx_status_type_pid` (`status`,`uid`,`pid`);

--
-- Indexes for table `ly_document_article`
--
ALTER TABLE `ly_document_article`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `ly_document_download`
--
ALTER TABLE `ly_document_download`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `ly_favor`
--
ALTER TABLE `ly_favor`
  ADD PRIMARY KEY (`fid`);

--
-- Indexes for table `ly_file`
--
ALTER TABLE `ly_file`
  ADD PRIMARY KEY (`id`),
...
--
-- Indexes for table `ly_friendlink`
--
ALTER TABLE `ly_friendlink`
  ADD PRIMARY KEY (`aid`);

--
-- Indexes for table `ly_goods`
--
ALTER TABLE `ly_goods`
  ADD PRIMARY KEY (`goods_id`),
  ADD KEY `goods_id` (`goods_id`),
  ADD KEY `num_iid` (`num_iid`);

--
-- Indexes for table `ly_goods_extra`
--
ALTER TABLE `ly_goods_extra`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `ly_goods_to_tags`
--
ALTER TABLE `ly_goods_to_tags`
  ADD PRIMARY KEY (`goods_id`,`tag_id`);

--
-- Indexes for table `ly_goods_type`
--
ALTER TABLE `ly_goods_type`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `ly_hooks`
--
ALTER TABLE `ly_hooks`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `name` (`name`);

--
-- Indexes for table `ly_link`
--
ALTER TABLE `ly_link`
  ADD PRIMARY KEY (`lid`);

--
-- Indexes for table `ly_member`
--
ALTER TABLE `ly_member`
  ADD PRIMARY KEY (`uid`),
  ADD KEY `status` (`status`);

--
-- Indexes for table `ly_menu`
--
ALTER TABLE `ly_menu`
  ADD PRIMARY KEY (`id`),
  ADD KEY `pid` (`pid`);
...
--
-- Indexes for table `ly_model`
--
ALTER TABLE `ly_model`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `ly_nav`
--
ALTER TABLE `ly_nav`
  ADD PRIMARY KEY (`id`),
  ADD KEY `pid` (`pid`);
...
--
-- Indexes for table `ly_news`
--
ALTER TABLE `ly_news`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `ly_orders`
--
ALTER TABLE `ly_orders`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `ly_orders_status`
--
ALTER TABLE `ly_orders_status`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `ly_page`
--
ALTER TABLE `ly_page`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `ly_picture`
--
ALTER TABLE `ly_picture`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `ly_raiders`
--
ALTER TABLE `ly_raiders`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `ly_scheme_keyword`
--
ALTER TABLE `ly_scheme_keyword`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `ly_search_keyword`
--
ALTER TABLE `ly_search_keyword`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `ly_support`
--
ALTER TABLE `ly_support`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `ly_tag`
--
ALTER TABLE `ly_tag`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `ly_topic`
--
ALTER TABLE `ly_topic`
  ADD PRIMARY KEY (`tid`);

--
-- Indexes for table `ly_trans_type`
--
ALTER TABLE `ly_trans_type`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `ly_ucenter_admin`
--
ALTER TABLE `ly_ucenter_admin`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `ly_ucenter_app`
--
ALTER TABLE `ly_ucenter_app`
  ADD PRIMARY KEY (`id`),
  ADD KEY `status` (`status`);

--
-- Indexes for table `ly_ucenter_member`
--
ALTER TABLE `ly_ucenter_member`
  ADD PRIMARY KEY (`id`),
...
--
-- Indexes for table `ly_ucenter_setting`
--
ALTER TABLE `ly_ucenter_setting`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `ly_url`
--
ALTER TABLE `ly_url`
  ADD PRIMARY KEY (`id`),
...
--
-- Indexes for table `ly_userdata`
--
ALTER TABLE `ly_userdata`
...
--
-- 使用表AUTO_INCREMENT `ly_action`
--
ALTER TABLE `ly_action`
  MODIFY `id` int(11) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT '主键', AUTO_INCREMENT=12;
--
-- 使用表AUTO_INCREMENT `ly_action_log`
--
ALTER TABLE `ly_action_log`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT '主键', AUTO_INCREMENT=206;
--
-- 使用表AUTO_INCREMENT `ly_addons`
--
ALTER TABLE `ly_addons`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT '主键', AUTO_INCREMENT=17;
--
-- 使用表AUTO_INCREMENT `ly_article`
--
ALTER TABLE `ly_article`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
--
-- 使用表AUTO_INCREMENT `ly_attachment`
--
ALTER TABLE `ly_attachment`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;
--
-- 使用表AUTO_INCREMENT `ly_attribute`
--
ALTER TABLE `ly_attribute`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=33;
--
-- 使用表AUTO_INCREMENT `ly_auth_group`
--
ALTER TABLE `ly_auth_group`
  MODIFY `id` mediumint(8) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT '用户组id,自增主键', AUTO_INCREMENT=3;
--
-- 使用表AUTO_INCREMENT `ly_auth_rule`
--
ALTER TABLE `ly_auth_rule`
  MODIFY `id` mediumint(8) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT '规则id,自增主键', AUTO_INCREMENT=248;
--
-- 使用表AUTO_INCREMENT `ly_banner`
--
ALTER TABLE `ly_banner`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
--
-- 使用表AUTO_INCREMENT `ly_category`
--
ALTER TABLE `ly_category`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT '分类ID', AUTO_INCREMENT=40;
--
-- 使用表AUTO_INCREMENT `ly_category_goods`
--
ALTER TABLE `ly_category_goods`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT '宝贝分类id', AUTO_INCREMENT=23;
--
-- 使用表AUTO_INCREMENT `ly_collect_goods`
--
ALTER TABLE `ly_collect_goods`
  MODIFY `id` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=91;
--
-- 使用表AUTO_INCREMENT `ly_config`
--
ALTER TABLE `ly_config`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT '配置ID', AUTO_INCREMENT=68;
--
-- 使用表AUTO_INCREMENT `ly_document`
--
ALTER TABLE `ly_document`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT '文档ID', AUTO_INCREMENT=3;
--
-- 使用表AUTO_INCREMENT `ly_favor`
--
ALTER TABLE `ly_favor`
  MODIFY `fid` int(10) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT '收藏id', AUTO_INCREMENT=9;
--
-- 使用表AUTO_INCREMENT `ly_file`
--
ALTER TABLE `ly_file`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT '文件ID';
--
-- 使用表AUTO_INCREMENT `ly_friendlink`
--
ALTER TABLE `ly_friendlink`
  MODIFY `aid` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
--
-- 使用表AUTO_INCREMENT `ly_goods`
--
ALTER TABLE `ly_goods`
  MODIFY `goods_id` mediumint(8) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=474;
--
-- 使用表AUTO_INCREMENT `ly_goods_extra`
--
ALTER TABLE `ly_goods_extra`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
--
-- 使用表AUTO_INCREMENT `ly_goods_type`
--
ALTER TABLE `ly_goods_type`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
--
-- 使用表AUTO_INCREMENT `ly_hooks`
--
ALTER TABLE `ly_hooks`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT '主键', AUTO_INCREMENT=17;
--
-- 使用表AUTO_INCREMENT `ly_link`
--
ALTER TABLE `ly_link`
  MODIFY `lid` mediumint(5) UNSIGNED NOT NULL AUTO_INCREMENT;
--
-- 使用表AUTO_INCREMENT `ly_member`
--
ALTER TABLE `ly_member`
  MODIFY `uid` int(10) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT '用户ID', AUTO_INCREMENT=6;
--
-- 使用表AUTO_INCREMENT `ly_menu`
--
ALTER TABLE `ly_menu`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT '文档ID', AUTO_INCREMENT=173;
--
-- 使用表AUTO_INCREMENT `ly_model`
--
ALTER TABLE `ly_model`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT '模型ID', AUTO_INCREMENT=4;
--
-- 使用表AUTO_INCREMENT `ly_nav`
--
ALTER TABLE `ly_nav`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT '频道ID', AUTO_INCREMENT=8;
--
-- 使用表AUTO_INCREMENT `ly_news`
--
ALTER TABLE `ly_news`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
--
-- 使用表AUTO_INCREMENT `ly_orders`
--
ALTER TABLE `ly_orders`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;
--
-- 使用表AUTO_INCREMENT `ly_orders_status`
--
ALTER TABLE `ly_orders_status`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;
--
-- 使用表AUTO_INCREMENT `ly_page`
--
ALTER TABLE `ly_page`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
--
-- 使用表AUTO_INCREMENT `ly_picture`
--
ALTER TABLE `ly_picture`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT '主键id自增', AUTO_INCREMENT=54;
--
-- 使用表AUTO_INCREMENT `ly_raiders`
--
ALTER TABLE `ly_raiders`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
--
-- 使用表AUTO_INCREMENT `ly_scheme_keyword`
--
ALTER TABLE `ly_scheme_keyword`
  MODIFY `id` smallint(5) UNSIGNED NOT NULL AUTO_INCREMENT;
--
-- 使用表AUTO_INCREMENT `ly_search_keyword`
--
ALTER TABLE `ly_search_keyword`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;
--
-- 使用表AUTO_INCREMENT `ly_support`
--
ALTER TABLE `ly_support`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
--
-- 使用表AUTO_INCREMENT `ly_tag`
--
ALTER TABLE `ly_tag`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
--
-- 使用表AUTO_INCREMENT `ly_topic`
--
ALTER TABLE `ly_topic`
  MODIFY `tid` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
--
-- 使用表AUTO_INCREMENT `ly_trans_type`
--
ALTER TABLE `ly_trans_type`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
--
-- 使用表AUTO_INCREMENT `ly_ucenter_admin`
--
ALTER TABLE `ly_ucenter_admin`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT '管理员ID';
--
-- 使用表AUTO_INCREMENT `ly_ucenter_app`
--
ALTER TABLE `ly_ucenter_app`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT '应用ID';
--
-- 使用表AUTO_INCREMENT `ly_ucenter_member`
--
ALTER TABLE `ly_ucenter_member`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT '用户ID', AUTO_INCREMENT=6;
--
-- 使用表AUTO_INCREMENT `ly_ucenter_setting`
--
ALTER TABLE `ly_ucenter_setting`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT '设置ID';
--
-- 使用表AUTO_INCREMENT `ly_url`
--
ALTER TABLE `ly_url`
